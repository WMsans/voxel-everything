...
public:
	...
	// Records the stats clear, one compute dispatch (one thread per candidate page), and an
	// async stats readback. The caller must have already uploaded the indirect args with

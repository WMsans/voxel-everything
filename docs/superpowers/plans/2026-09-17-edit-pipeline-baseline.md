...
Commit: `8fb015a`. Recorded 2026-09-17 on Darwin Jeremys-Mac-mini.attlocal.net / Apple M1 / Godot 4.7.2.stable.official.ed1daf0bf.
...
# test_gpu_timing_scopes: tests=1 failures=0 errors=0
...
# test_cel_object: tests=3 failures=0 errors=0
...
# test_frame_shipped_golden: tests=1 failures=0 errors=0
...
# test_render_lifetime_contract: tests=6 failures=0 errors=0
...
# test_world_field_consumers: tests=4 failures=0 errors=0
...
# test_sun_cascades_gpu: tests=7 failures=2 errors=0
...
# test_override_region_border: tests=6 failures=0 errors=0
...
# test_voxel_world_raycast: tests=3 failures=0 errors=0
